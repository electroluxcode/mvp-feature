...
🌐 **在线演示**: https://mvp-feature.vercel.app/

基于 feature 技术栈构建的浏览器端文档处理解决方案，支持在客户端完成文档的查看、编辑与转换，所有操作均在用户设备上执行，无需依赖后端服务。
...
1. 访问 [在线编辑器](https://mvp-feature.vercel.app/)
2. 选择编辑器类型：
...
- **feature SDK**: 集成 feature 官方 JavaScript SDK，提供文档编辑核心能力
...
访问地址：https://mvp-feature.vercel.app/
...
- **源目录**: `public/packages/feature/7`
- **目标目录**: `public/packages/feature/7-minify`
...
│   └── components/       # 通用组件
├── public/               # 静态资源
│   ├── web-apps/         # feature Web 应用资源
│   ├── sdkjs/            # feature SDK 资源
│   └── wasm/             # WebAssembly 转换器
└── feature-x2t-wasm/  # x2t-wasm 源码
```
...
- [feature API 文档](https://api.feature.com/zh-CN/docs/docs-api/usage-api/config/document/) - feature 官方 API 参考
- [ranuts/document](https://github.com/ranuts/document) - 参考静态资源实现
- [feature Web Apps](https://github.com/feature/web-apps) - feature 网页应用源码
- [feature SDK](https://github.com/feature/sdkjs) - feature JavaScript SDK
- [x2t-wasm](https://github.com/cryptpad/feature-x2t-wasm) - WebAssembly 文档转换器
